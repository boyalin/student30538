...
- *Note: we will not be able to cover all of these topics today -- the goal is just to give you a taste of what language models can do*
...
Hint: if you are running the code interactively, you'll need to first run `alt.renderers.enable("jupyter")`
...
- Known entity detection can differentiate between "Apple" the company and "Apples" the fruit 
