...
![](pictures/directory_2_pc.png){ width=40% fig-align="center"}
...
2. UI side code to display the plot
...
are deployed *from Terminal*, rather than directly running the Python code
